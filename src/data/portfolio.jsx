	...
	},
	{
		...
		skills: [
			...
			},
			{
				name: "InertiaJS",
				type: "i",
				icon: "devicon-inertiajs-plain-wordmark",
				hideName: true,
			},
			{
				name: "NestJS",
	...
	},
	{
		...
		skills: [
			...
			},
			{
				name: "Elasticsearch",
				type: "i",
				icon: "devicon-elasticsearch-plain-wordmark",
				hideName: true,
			},
			{
				name: "Prometheus",
				type: "i",
				icon: "devicon-prometheus-plain-wordmark",
				hideName: true,
			},
			{
				name: "Grafana",
...
export const websites = [
	{
		...
		type: "website",
		description:
			"A contribution platform for adventures, parties, outings, send forths and all you can think of within friends, helps collate funds using a simple contribution link.",
		languages:
			"Laravel, MySql, HTML, SCSS, MaterialUI, React, InertiaJS, Payments API",
		timeline: "1 month",
		images: letschipin,
	...
	},
	{
		...
		type: "UI",
		description:
			"A non-functional dashboard UI mockup of a financial service application, features includes, cards, recent transactions, activities, expense statistics and much more",
	...
	},
	{
		...
		type: "website",
		description:
			"A banking application for users to create/close accounts, transfer or receive funds from other accounts.",
	...
	},
	{
		...
		type: "website",
		description:
			"Kainetix Sports Management is a talent management and sports marketing specialist, taking advantage of the abundance of talents in the African region",
	...
	},
	{
		...
		type: "website",
		description:
			"Tecky is aimed at connecting freelance creators in programming, photoshop, designing e.t.c. with clients looking for these creators to build a project.",
		languages: "Laravel, MySql, HTML, CSS, Bootstrap, React, Redux",
		timeline: "1 month",
		images: tecky,
	...
	},
	{
		...
		type: "website",
		description:
			"Yalla! Express is licensed by the Nigerian Postal Service Courier Regulatory Department (“NIPOST CRD”), to provide courier services to customers in Nigeria. They offer same day pickup and delivery solutions to individual and corporate customers across Lagos, Nigeria.",
	...
	},
	{
		...
		type: "website",
		description:
			"A real estate company established to deliver a higher standard of living driven by better quality designs and valuable features",
		languages: "Laravel, MySql, HTML, CSS, Bootstrap",
		timeline: "2 weeks",
