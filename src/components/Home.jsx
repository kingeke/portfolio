            ...
            <AnimatedOnScroll animationIn="fadeInUp">
                <div className="row vh-100 p-sm-5 pt-5 pb-5">
                    <div className="col-12 my-auto">
                        ...
                        <br />
                        <h4>Just your friendly Engineering Manager. </h4>
                        <br />
                        ...
                        <div className="mt-4 social-links">
                            ...
                            <a href="https://www.freecodecamp.org/kingeke" title="FreeCodeCamp" className="ms-3" target="_blank" rel="noopener noreferrer">
